                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="card-title">Create Investment</div>
                                    <form method="POST" action="{{ route('investments.store') }}">
                                        ...
                                        <div class="form-group row mb-4">
                                            <label for="investment_date" class="col-md-4 col-form-label text-md-right">Investment Date</label>
                        
                                            <div class="col-md-6">
                                                <input id="investment_date" type="date" class="form-control @error('investment_date') is-invalid @enderror" name="investment_date" value="{{ old('investment_date') }}" required>
